$(function(){
    ...
    var base_url='http://localhost/jadwal_jaga/'; // Here i define the base_url
    ...
    $('#calendar').fullCalendar({
        ...
        dayNamesShort: ['Minggu', 'Senin', 'Selasa', 'Rabu', 'Kamis', 'Jumat', 'Sabtu'],//nama default dari hari
            ...
            modal({
                ...
                title: 'Input Jadwal Jaga' // Modal title
            });
            },
...
//modal input libur
    // $('#input_libur').on('click', '#add-event',  function(e){
    //     if(validator(['title'])) {
    //         $.post(base_url+'calendar/addEvent', {
    //             title: $('#title').val(),
    //             status: $('#status').val(),
    ...
    function validator(elements) {
        ...
        if(errors) {
            $('.error').html('Please insert primary or secondary dev');
            return false;
        }
        return true;
    }
