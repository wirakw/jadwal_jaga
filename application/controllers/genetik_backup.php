...
class Genetik extends CI_Controller
{
    ...
    private $jumlah_pengampu;
    	...
    	function penjadwalan(){
          ...
          $this->form_validation->set_rules('end','end','xss_clean|required');
            ...
            $this->jumlah_pengampu = 2 * intval($selisih) + 2;
    ...
    private function CekFitness($indv) //$indv inisial statenya berapa ?
    {
        ...
        for ($i = 0; $i < $this->jumlah_pengampu; $i++)
        {
          ...
          $sama = 0;
            for ($j = 0; $j < $this->jumlah_pengampu; $j++) {
                ...
                $secondary_a = intval($this->individu[$indv][$j][3]);
        ...
        if(!isset($hari_a) && !isset($hari_b)){
                //primary == primary
                if ($hari_a == $hari_b && $primary_a == $primary_b && $primary_a == $secondary_a && $primary_a == $secondary_b && $primary_b == $secondary_a && $primary_b == $secondary_b ){
                    $penalty+=3;
                }
                if ($hari_a == $hari_b && $primary_a == $primary_b && $primary_a == $secondary_a && $primary_a == $secondary_b && $primary_b == $secondary_a && $primary_b != $secondary_b ){
                    $penalty+=3;
              ...
              //dua tidak sama
                ...
                //primary == secondary
                if ($hari_a == ($hari_b+1) && $primary_a == $primary_b && $primary_a == $secondary_a && $primary_a == $secondary_b && $primary_b == $secondary_a && $primary_b == $secondary_b ){
                    $penalty+=3;
                }
                if ($hari_a == ($hari_b+1) && $primary_a == $primary_b && $primary_a == $secondary_a && $primary_a == $secondary_b && $primary_b == $secondary_a && $primary_b != $secondary_b ){
                    $penalty+=3;
              ...
              //dua tidak sama
                ...
                if ($hari_a == ($hari_b+2) && $primary_a == $primary_b && $primary_a == $secondary_a && $primary_a == $secondary_b && $primary_b == $secondary_a && $primary_b == $secondary_b ){
                    $penalty+=3;
                }
                if ($hari_a == ($hari_b+2) && $primary_a == $primary_b && $primary_a == $secondary_a && $primary_a == $secondary_b && $primary_b == $secondary_a && $primary_b != $secondary_b ){
                    $penalty+=3;
